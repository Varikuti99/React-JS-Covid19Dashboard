...
class StateWiseCovidCases extends Component {
  state = {
    isLoading: true,
    activeTab: true,
    category: 'Confirmed',
      ...
      <>
        ...
        <div className="each-state-container">
          <div className="state-content-container">
            {isLoading ? this.renderLoader() : this.renderStateDetails()}
          </div>
        </div>
        <Footer />
      </>
...
export default StateWiseCovidCases
// 218 testid="stateDetailsLoader"
// testid="lineChartsContainer"
// 303   testid="topDistrictsUnorderedList"
